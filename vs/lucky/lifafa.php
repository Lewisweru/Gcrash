    ...
    display:none;">
				<div class="col-12">
					...
					<div class="inpbcx rc tfcb" style="border-bottom: white;">
						<span style="color:#28a745;font-size:70px;    position:fixed;left: 35%;"> KSH<?php echo $new;?></span>
						<span style='position: fixed;left: 30%;padding-top:100px;'>You got KSH<?php echo $new;?> Lucky Rupees</span>
				...
				<div class="col-12 mt-4 pa-0"><div class="btn-main act openair"  onclick="window.location.href='https://fiewin20.com/'">Visit 9987</div></div>
			</div>
