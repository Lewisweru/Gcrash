...
">Jhon Doe</h6>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="upi" class="nav-item nav-link"><i class="fa fa-table me-2"></i>upi change</a>
                     <a href="adduser" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Add New User</a>
 ...
 <div data-v-309ccc10="" class="recharge">
        <div data-v-309ccc10="" class="recharge_box">
             <h1>Andhar:KSH&nbsp<?php echo $red;?></h1><br>
             <h1>Bahar:KSH&nbsp<?php echo $green;?></h1><br>
             <h1>Tie:KSH&nbsp<?php echo $violet;?></h1><br>
      <h1>1---ANDHAR</h1><br>
      <h1>2---BAHAR</h1><br>
      <h1>3---TIE</h1><br>
