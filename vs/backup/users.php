...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $dataRow = $dataRow."<tr class='user' ><td></td><td >$row2[1]</td><td><a href='/ipfind.php?ip=$row2[ip]'>Details</a></td><td >$row2[16]</td><td>$row2[2]</td><td> KSH$balace0 </td><td><a href='/report.php?user=$row2[1]'>Information</a></td></tr>";
}
