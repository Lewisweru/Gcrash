...
">Jhon Doe</h6>
 ...
 <div data-v-309ccc10="" class="recharge">
        <div data-v-309ccc10="" class="recharge_box">
             <h1>Red:KSH&nbsp<?php echo $red;?></h1><br>
             <h1>Green:KSH&nbsp<?php echo $green;?></h1><br>
             <h1>Small:KSH&nbsp<?php echo $small;?></h1><br>
             <h1>Big:KSH&nbsp<?php echo $big;?></h1><br>
             <h1>Violet:KSH&nbsp<?php echo $violet;?></h1><br>
             <div style="font-size:20px;">
             
             <h1><span>zero:KSH&nbsp<?php echo $zero;?>&nbsp&nbsp</span><span>one:KSH&nbsp<?php echo $one;?>&nbsp&nbsp</span></h1><br>
             <h1><span>two:KSH&nbsp<?php echo $two;?>&nbsp&nbsp</span><span>three:KSH&nbsp<?php echo $three;?>&nbsp&nbsp</span></h1><br>
             <h1><span>four:KSH&nbsp<?php echo $four;?>&nbsp&nbsp</span><span>five:KSH&nbsp<?php echo $five;?>&nbsp&nbsp</span></h1><br>
             <h1><span>six:KSH&nbsp<?php echo $six;?>&nbsp&nbsp</span><span>seven:KSH&nbsp<?php echo $seven;?>&nbsp&nbsp</span></h1><br>
             <h1><span>eight:KSH&nbsp<?php echo $eight;?>&nbsp&nbsp</span><span>nine:KSH&nbsp<?php echo $nine;?>&nbsp&nbsp</span></h1><br></div>
