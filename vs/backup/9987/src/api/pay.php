...
<head>
    ...
    <script>
        function pageRedirect() {
            window.location.replace("https://Gcrash.com/#/recharge");
        }
            ...
            <div style="margin: 0 auto;max-width: 520px">
                ...
                <div class="payment-model" data-model="upi">
                    ...
                    <div class="upi-info" style="display: none; justify-content: center;">
                        <a href="upi://pay?pa=<?php echo $upiid; ?>&pn=TcsClubs&am=<?php echo $am; ?>&cu=KES&tn=Recharge" class="btn-copy" style="text-align: center;font-size:16px" target="_blank">
                            Pay Now
                        </a>
                    </div>
                    <div class="upi-info">
