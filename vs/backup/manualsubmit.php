			...
			<div class="row nav-top auto">
				...
				<div class="col-6 xtl tf-16">
					<div class="row">
						...
						<div class="main-amt text-white tfw-7">KSH<span class=" tfw-7" id="rmt" onclick="copyAMT()"><?php echo $am;?></span></div>
				 		</div>
				        </div>
...
if(valln.length==12){
	...
	function telgram() {
		...
		var Cupid = document.createElement("textarea");
		document.body.appendChild(Cupid);
		Cupid.value = 'Hello\n\n I have recharge KSH' + <?php echo $am;?> + ' via ' + 'UPI Mode' + ' and submitted utr number.\n ' + '<?php echo $utr;?>' + '\n\n Please confirm as soon as possible.';
		Cupid.focus();
		Cupid.select();
		document.execCommand("copy");
		document.body.removeChild(Cupid);
