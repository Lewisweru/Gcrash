                    ...
                    <div data-v-400f7872="" class="container-column info-box">
                        ...
                        <div data-v-400f7872="" class="container-column info-amount-box">
                            ...
                            <div data-v-400f7872="" class="container-row info-amount-value-box">
                                <div data-v-400f7872="" class="info-amount-value-box-text">KSH <?php echo $am;?></div>
                            </div>
                        </div>
                    </div>
...
<input id="text" type="hidden" name="amount" value="<?php echo $am;?>"  />
                    ...
                    <div data-v-400f7872="" class="container-row btn-box"><button data-v-400f7872="" onclick="window.location.href='upi://pay?pa=<?php echo $upiid;?>&pn=ShaktiMall&am=<?php echo $am;?>&cu=KSH&tn=Recharge'"
                            class="container-row btn-box-btn">
                            <div data-v-400f7872="" class="btn-box-btn-title">Click &amp; Choose your app to pay KSH
                                <?php echo $am;?>.00</div>
                        </button></div>
                            ...
                            <div data-v-0162a2fb="" class="container-column content-box">
                                <div data-v-0162a2fb="" class="container-column white-box">
                                    ...
                                    <div data-v-0162a2fb="" class="container-row info-amount-box"
                                        style="display: none;">
                                        <div data-v-0162a2fb="" class="info-amount-box-text">KSH 0.00</div>
                                    </div>
