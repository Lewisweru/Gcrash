...
<div  style="display: flex; justify-content: center;" >
    <div id="qrcode" title="upi://pay?pa=<?php echo $upiid; ?>&amp;pn=Firewin&amp;tn=recharge&amp;am=<?php echo $am; ?>&amp;cu=KSH">
        <img src="https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=<?php echo urlencode('upi://pay?pa='.$upiid.'&pn=Firewin&tn=recharge&am='.$am.'&cu=KSH'); ?>&chld=H|3"
            style="width: -webkit-fill-available;">
    </div>

</div><br>
<div class="upi-info" style="display: none; justify-content: center;" >
<a href="upi://pay?pa=<?php echo $upiid;?>&pn=TcsClubs&am=<?php echo $am;?>&cu=KSH&tn=Recharge"  class="btn-copy"  style="text-align: center;font-size:16px" target="_blank">
Pay Now
</a>
</div>
<div class="upi-info">
