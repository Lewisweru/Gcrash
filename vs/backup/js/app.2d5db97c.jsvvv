    ...
    var A = {
            7703: function (A, e, n) {
                ...
                const C = { class: "container-fluid" },
                    R = { class: "row mcas" },
                    E = { class: "col-md-6 col-lg-4 main", style: { background: "#343a40" } },
                    Z = { class: "row", id: "warea" },
                    L = { class: "col-12" },
                    Q = { class: "row walifo" },
                    M = { class: "col-6 xtl", style: { color: "white" } },
                    P = (0, a._)("div", { class: "mt-1 mb-2 tf-16" }, "Balance", -1),
                    G = { class: "mt-1 mb-2 tfcdb tfw-6 tffss tf-18 tfwr ddavc", style: { color: "white" } },
                    x = { class: "tf-24 tfw-7", id: "" },
                    N = { class: "pr-2" },
                    K = { class: "mt-1 tf-16 tfcdg", style: { color: "white" } },
                    j = { id: "u_id" },
                    Y = (0, a._)(
                        "div",
                        ...
                        [
                            (0, a._)("div", { class: "row tf-12 tfcdb tfw-7 1wtj0ep pbt-18" }, [
                                (0, a._)("div", { class: "col-6 pdr5" }, [
                                    (0, a._)("div", { class: "taskR", style: { background: "-webkit-linear-gradient(top,#F6E3A3 0%,#D2A753 100%)" }, onclick: "window.location.href='#/taskReward'" }, [
                                        (0, a._)("img", { src: h, height: "36" }),
                                        (0, a._)("span", { class: "pl-10", style: { color: "black" } }, "Task reward"),
                                    ]),
                                ]),
                                (0, a._)("div", { class: "col-6 pdl5" }, [
                                    (0, a._)("div", { class: "CheckR", style: { background: "-webkit-linear-gradient(top,#F6E3A3 0%,#D2A753 100%)" }, onclick: "window.location.href='#/CheckIn'" }, [
                                ...
                                (0, a._)("div", { class: "col-6 pdl5", onclick: "window.location.href='https://t.me/nex_bet_official'" }, [(0, a._)("div", { class: "icard" }, [(0, a._)("img", { src: D })])]),
                            ]),
                        ],
                        -1
                    ),
                                        ...
                                        (0, a._)("div", L, [
                                            (0, a._)("div", Q, [
                                                (0, a._)("div", M, [
                                                    P,
                                                    (0, a._)("div", G, [
                                                        (0, a._)("span", x, "KSH" + (0, d.zw)(this.balance), 1),
                ...
                var X = n(9669),
                    ...
                    _ = {
                        ...
                        beforeCreate: function () {
                            q()
                                .get("https://gcrash.com/9987/src/api/bet.php?action=verifytoken&user=" + localStorage.getItem("username"), {
                        ...
                        methods: {
                            ...
                            getUserdetails() {
                                (this.username = localStorage.getItem("username")),
                                    q()
                                        .get("https://gcrash.com/9987/src/api/bet.php?action=getuserinfo&user=" + this.username, { headers: { Authorization: `Bearer ${this.secretKey}` } })
                                        .then((A) => {
