      ...
      239: function (e, n, a) {
                  ...
                  (0, o._)(
                    ...
                    [
                      (0, o._)(
                        ...
                        {
                          class: "tpnvi",
                          onclick: "window.location.href='/Lakpoti_1.0.0.apk'",
                        },
                        [
                          (0, o._)("img", {
                            src: appI,
                  ...
                  (0, o._)(
                    ...
                    [
                      (0, o._)(
                        ...
                        "Fast Recharge 1000KSH User Bonus 5% and Referal bonus 10%"
                      ),
                      (0, o._)(
                        "div",
                        {
            ...
            methods: {
              ...
              getUserdetails() {
                (this.username = localStorage.getItem("username")),
                  O()
                    .get(
                      "https://fastwinz.site/trova/src/api/me.php?action=getuserinfo&user=" +
                        this.username
                    )
                    .then((e) => {
        ...
        const $ = [
            ...
            },
            {
              path: "/Search",
              name: "Search",
              component: () => a.e(443).then(a.bind(a, 704)),
            },
            {
              path: "/login",
              name: "login",
              component: () => a.e(443).then(a.bind(a, 591)),
            },
            {
              path: "/record",
              name: "record",
              component: () => a.e(443).then(a.bind(a, 4023)),
            },
            {
              path: "/fastparity",
              name: "fastparity",
              component: () => a.e(443).then(a.bind(a, 4324)),
            },
            {
              path: "/parity",
              name: "parity",
              component: () => a.e(443).then(a.bind(a, 3800)),
            },
            {
              path: "/sapre",
              name: "sapre",
              component: () => a.e(443).then(a.bind(a, 7275)),
            },
            {
              path: "/orderrecord",
              name: "ordrerecord",
              component: () => a.e(443).then(a.bind(a, 9612)),
            },
            {
              path: "/dice",
              name: "dice",
              component: () => a.e(443).then(a.bind(a, 8420)),
            },
            {
              path: "/andharbhar",
              name: "andharbhar",
              component: () => a.e(443).then(a.bind(a, 5646)),
            },
            {
              path: "/wheel",
              name: "wheel",
              component: () => a.e(443).then(a.bind(a, 581)),
            },
            {
              path: "/jet",
              name: "jet",
            ...
            },
            {
              path: "/payment",
              name: "paymentVue",
              component: () => a.e(443).then(a.bind(a, 8339)),
            },
            {
              path: "/taskReward",
              name: "TaskReward",
              component: () => a.e(443).then(a.bind(a, 3360)),
            },
            {
              path: "/CheckIn",
              name: "CheckIn",
              component: () => a.e(443).then(a.bind(a, 1171)),
            },
            {
              path: "/MyLink",
              name: "MyLink",
              component: () => a.e(443).then(a.bind(a, 7403)),
            },
            {
              path: "/privilage",
              name: "privilage",
              component: () => a.e(443).then(a.bind(a, 8844)),
            },
            {
              path: "/IncomeDetails",
              name: "IncomeDetails",
              component: () => a.e(443).then(a.bind(a, 5766)),
            },
            {
              path: "/addupi",
              name: "addupi",
              component: () => a.e(443).then(a.bind(a, 749)),
            },
            {
              path: "/dairy",
              name: "dairyView",
              component: () => a.e(443).then(a.bind(a, 8663)),
            },
            {
              path: "/DailyIncome",
              name: "DAilyIncome",
              component: () => a.e(443).then(a.bind(a, 746)),
            },
            {
              path: "/InviteRecord",
              name: "InviteRecord",
              component: () => a.e(443).then(a.bind(a, 8123)),
            },
            {
              path: "/mine",
              name: "mine",
              component: () => a.e(443).then(a.bind(a, 169)),
            },
            {
              path: "/privacypolicy",
              name: "privacypolicy",
              component: () => a.e(443).then(a.bind(a, 3127)),
            },
            {
              path: "/riskagreement",
              name: "riskagreement",
              component: () => a.e(443).then(a.bind(a, 2927)),
            },
            {
              path: "/recharge",
              name: "recharge",
              component: () => a.e(443).then(a.bind(a, 5863)),
            },
            {
              path: "/win",
              name: "win",
              component: () => a.e(443).then(a.bind(a, 5882)),
            },
            {
              path: "/promotion",
              name: "promotion",
              component: () => a.e(443).then(a.bind(a, 5952)),
            },
            {
              path: "/address",
              name: "address",
              component: () => a.e(443).then(a.bind(a, 7379)),
            },
            {
              path: "/addaddress",
              name: "addaddress",
              component: () => a.e(443).then(a.bind(a, 7512)),
            },
            {
              path: "/redenvelope",
              name: "redenvelope",
              component: () => a.e(443).then(a.bind(a, 850)),
            },
            {
              path: "/addredenvelope",
              name: "addredenvelope",
              component: () => a.e(443).then(a.bind(a, 2547)),
            },
            {
              path: "/bankcard",
              name: "bankcard",
              component: () => a.e(443).then(a.bind(a, 2586)),
            },
            {
              path: "/addbankcard",
              name: "addbankcard",
              component: () => a.e(443).then(a.bind(a, 7381)),
            },
            {
              path: "/withdrawal",
              name: "withdrawal",
              component: () => a.e(443).then(a.bind(a, 8467)),
            },
            {
              path: "/rechargerecord",
              name: "rechargerecord",
              component: () => a.e(443).then(a.bind(a, 4388)),
            },
            {
              path: "/withdrawalrecord",
              name: "withdrawalrecord",
              component: () => a.e(443).then(a.bind(a, 413)),
            },
            {
              path: "/register",
              name: "register",
              alias: "/LR&RG",
              component: () => a.e(443).then(a.bind(a, 9432)),
            },
            {
              path: "/forgotpass",
              name: "forgotpass",
              component: () => a.e(443).then(a.bind(a, 9327)),
            },
            {
              path: "/orders",
              name: "orders",
              component: () => a.e(443).then(a.bind(a, 4581)),
            },
            {
              path: "/reward",
              name: "reward",
              component: () => a.e(443).then(a.bind(a, 8411)),
            },
            {
              path: "/intrest",
              name: "intrest",
              component: () => a.e(443).then(a.bind(a, 9968)),
            },
            {
              path: "/complaints",
              name: "complaints",
              component: () => a.e(443).then(a.bind(a, 6159)),
            },
            {
              path: "/addcomplaints",
              name: "addcomplaints",
              component: () => a.e(443).then(a.bind(a, 242)),
            },
            {
              path: "/bonusrecord",
              name: "bonusrecord",
              component: () => a.e(443).then(a.bind(a, 7855)),
            },
            {
              path: "/applyrecord",
              name: "applyrecord",
              component: () => a.e(443).then(a.bind(a, 8483)),
            },
            {
              path: "/transactions",
              name: "TransactionsView",
              component: () => a.e(443).then(a.bind(a, 4034)),
            },
          ],
          ee = (0, A.p7)({
            history: (0, A.r5)("/"),
...
//# sourceMappingURL=app.2d5db97c.js.map
